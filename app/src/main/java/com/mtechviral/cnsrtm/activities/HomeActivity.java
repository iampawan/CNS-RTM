...
import com.mtechviral.cnsrtm.fragments.EquipmentFragment;

public class HomeActivity extends AppCompatActivity implements View.OnClickListener {
    private static final String[] pageTitle = {"Equipments","Tab2","Tab3","Tab4"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TabLayout tabLayout = (TabLayout) findViewById(R.id.tab_layout_activity);
    ...
    private class ViewPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            return new EquipmentFragment(position);
        }
